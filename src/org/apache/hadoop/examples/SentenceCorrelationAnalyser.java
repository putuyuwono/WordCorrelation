...
public class SentenceCorrelationAnalyser {
	...
	public static class MapClass extends
		...
		public void map(Object key, Text value, Context context)
			...
			if (!inputText.trim().equalsIgnoreCase("")) {
				context.getCounter(CORRELATION_ANALYSIS, RECORD_COUNTER_NAME)
						.increment(1);
			}
		}
	}
	...
	public static class ReduceClass extends
		...
		public void reduce(Text key, Iterable<DoubleWritable> values,
			...
			result.set(sum);
//			String s = key.toString() + "-> " + i + "/" + numOfRecord + "=" + sum; 
//			Text out = new Text(s);
//			context.write(out, result);
	...
	public static void main(String[] args) throws Exception {
		...
		String input = "/par-corr-input";
		String output = "/par-corr-output";
