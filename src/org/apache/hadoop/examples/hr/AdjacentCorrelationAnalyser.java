...
public class AdjacentCorrelationAnalyser {
	public static final String CORRELATION_ANALYSIS = "AdjacentCorrelationAnalysis";
...
//		private final static DoubleWritable one = new DoubleWritable(1);
	...
	public static class ReduceClass extends
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			Text outVal = new Text(String.valueOf(sum));
	...
	public static void run(String inputDir, String outputDir) throws Exception{
		...
		System.out.println("Running Adjacency Correlation Analyser");
		Job job = new Job(conf, "Adjacency Correlation Analyser");
		job.setJarByClass(AdjacentCorrelationAnalyser.class);
		job.setMapperClass(AdjacentCorrelationAnalyser.MapClass.class);
		job.setReducerClass(AdjacentCorrelationAnalyser.ReduceClass.class);
